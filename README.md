...
<p align="center"> <img src="HEADER_IMAGE_LINK_HERE" alt="Hues.AI Header" width="600"/> </p>

🌐 Live Demo

Experience Hues.AI instantly through my hosted demo:

🔗 https://mai2026-sdxl-lora-floorplan.hf.space
...
3️⃣ Additional optional model files

Only present if I add them later — but the current structure is perfectly valid. ✅
...
📊 SVG floorplan export
🏢 Multi-floor support
🛠️ Constraint-aware generation
...
Mariam Safwat Ibrahim Elewa 🌸
Menna El Sayed 🌟

🪶 Final Reflection

Hues.AI is a bridge between imagination and form — a tool that lets words condense into walls, spaces, and paths.
